...
def test_list(tmp_test_file):
    with h5py.File(tmp_test_file, 'r') as file:
        assert H5DatasetType.from_numpy_array(np.array(file["List/String"])) is H5DatasetType.String
...
def test_enum(tmp_test_file):
    # with h5py.File(tmp_test_file, 'r') as file:
    pass


def test_array1d(tmp_test_file):
    with h5py.File(tmp_test_file, 'r') as file:
        assert H5DatasetType.from_numpy_array(np.array(file["Array1D/Integer"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Array1D/Float"])) is H5DatasetType.Array1D


def test_numpy_arrays(tmp_test_file):
    with h5py.File(tmp_test_file, 'r') as file:
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/String/S"])) is H5DatasetType.String
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/String/a"])) is H5DatasetType.String

        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/int16"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/int32"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/int64"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/uint16"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/uint32"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Integer/uint64"])) is H5DatasetType.Array1D

        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Float/float16"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Float/float32"])) is H5DatasetType.Array1D
        assert H5DatasetType.from_numpy_array(np.array(file["Numpy Arrays/Float/float64"])) is H5DatasetType.Array1D
